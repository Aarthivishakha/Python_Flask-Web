...
Python 2.7 cannot install current analyzers. Run this tool set in an isolated
Python 3.10+ environment against the Python 2.7-compatible source. Keep analyzer
