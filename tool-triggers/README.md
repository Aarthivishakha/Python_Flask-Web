...
Python 3.6 cannot install current analyzers. Run this tool set in an isolated
Python 3.10+ environment against the Python 3.6-compatible source. Keep analyzer
